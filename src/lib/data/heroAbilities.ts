export const heroAbilities = {
		...
		facets: [
			{
				...
				gradient_id: 1,
				title: 'Vantage Point',
				description: 'Drow deals 30% more damage when attacking from high ground.',
		...
		facets: [
			{
				...
				description: 'Aftershock radius is increased by 30 for every level of Echo Slam.'
			},
			{
				id: 1,
		...
		facets: [
			{
				...
				description: "Mirana's Ultimate grants allies invisibility and movement speed.",
			...
			},
			{
				...
				description: 'Upon landing, Leap roots targets in a 250 radius for 1.5 =1.75 =2.0 =2.25s.'
			}
		]
	},
	...
	npc_dota_hero_morphling: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Flow',
				description:
					"Morphling's Primary Attribute is now Strength. Morphling gains 1% Spell Amp per 4 Agility.",
	...
	npc_dota_hero_lich: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_lich_jump_damage',
				level: 4
			}
		],
		facets: [
	...
	npc_dota_hero_shadow_shaman: {
		...
		facets: [
			...
			},
			{
				...
				description:
					'Summons a single massive Serpent Ward with 12x damage and 9x health and bounty values.'
			}
		]
	},
		...
		facets: [
			{
				...
				gradient_id: 3,
				title: 'Event Horizon',
				description: 'Units in a 600 radius moving away from Enigma have a 8% movespeed penalty.',
	...
	npc_dota_hero_venomancer: {
		...
		facets: [
			...
			},
			{
				...
				description:
					'When Venomous Gale impacts enemy heroes, 2 Plague Wards are created around them. Plague Wards also deal Septic Shock damage based on their attack damage.'
			}
		]
	},
	...
	npc_dota_hero_pugna: {
		...
		facets: [
			...
			},
			{
				...
				description: 'Pugna receives 1.5% spell amplification per destroyed tower.'
			}
		]
	},
	npc_dota_hero_templar_assassin: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Hidden Reach',
				description:
					'When in Meld, Templar increases her attack range by up to an additional 400 range over 1s.'
			}
		]
	},
	npc_dota_hero_viper: {
		...
		facets: [
			{
				...
				title: 'Hookup',
				description:
					"If there's another allied hero within 350 of Hookshot's hit target, Clockwerk and all allies in the area receive bonus armor, while refunding a portion of Hookshot's cooldown and manacost."
			},
			{
				id: 1,
			...
			},
			{
				...
				gradient_id: 1,
				title: 'Chainmeal',
				description: 'Clockwerk can consume Chainmails to permanently gain +4 armor.'
			}
		]
	},
	...
	npc_dota_hero_furion: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_furion_8',
				level: 2
			},
			{
		...
		facets: [
			{
				...
				description: 'After Sprout is cast, all trees in a 900 radius heal nearby allies.'
			},
			{
				id: 1,
	...
	npc_dota_hero_clinkz: {
		...
		talents: [
			...
			{
				name: 'special_bonus_attack_range_60',
				level: 2
			},
			{
	...
	npc_dota_hero_night_stalker: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Night Reign',
				description:
					'The game now starts at night instead of day. Night is longer than day. Night Stalker starts with a bonus level of Hunter in the Night.',
		...
		facets: [
			{
				...
				title: 'Stoked',
				description:
					'Firefly also lights Batrider on fire. He gains increasingly more Move Speed and Spell Amplification and burns away a portion of his max health each second.'
			},
			{
				id: 1,
	...
	npc_dota_hero_doom_bringer: {
		...
		facets: [
			...
			},
			{
				...
				description:
					'Doom can sell items for 85% of their value, but his buyback costs are increased by 20%.',
			...
			},
			{
				...
				description: "Every 6.66 minutes, Doom's duration is increased by 0.66s."
			}
		]
	},
	...
	npc_dota_hero_alchemist: {
		...
		facets: [
			...
			},
			{
				...
				gradient_id: 2,
				title: 'Dividends',
				description: "Alchemist gains +70 GPM for each Aghanim's Scepter he has granted to allies."
			}
		]
	},
	npc_dota_hero_invoker: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_invoker_facet_orb_level',
				level: 2
			},
			{
	...
	npc_dota_hero_silencer: {
		...
		facets: [
			...
			},
			{
				...
				description:
					'Increases the max level of Glaives of Wisdom. Level 5 Glaives of Wisdom bounce 1 time to a random target within 450 range.'
			},
			{
				id: 3,
	...
	npc_dota_hero_treant: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Uprooted',
				description:
					"This facet doesn't do anything. Treant Protector is still finding his roots..."
			}
		]
	},
		...
		facets: [
			{
				...
				title: 'Fat Chance',
				description:
					"Each point of Ogre Magi's Strength adds 0.06% to Ogre Magi's Multicast chance."
			},
			{
				id: 1,
	...
	npc_dota_hero_nyx_assassin: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Scuttle',
				description:
					'For the first 15s of Vendetta, Nyx Assassin is hasted and has unobstructed pathing.'
			}
		]
	},
	...
	npc_dota_hero_medusa: {
		...
		facets: [
			...
			},
			{
				...
				description:
					'Every 6 attacks, Medusa applies poison to her arrow that briefly reduces movement speed and attack speed.',
	...
	npc_dota_hero_troll_warlord: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Bad Influence',
				description:
					'During Battle Trance, Troll Warlord has increased max Fervor stacks and no attack speed limit. Battle Trance grants allied heroes 50% of the attack speed bonus. '
			}
		]
	},
	...
	npc_dota_hero_magnataur: {
		...
		facets: [
			...
			},
			{
				...
				description:
					"Increases the max level of Shockwave. Level 5 Shockwave causes it to return towards Magnus's location."
			},
			{
				id: 4,
	...
	npc_dota_hero_abaddon: {
		...
		facets: [
			...
			},
			{
				...
				description:
					'Mist Coil also deals 40 =60 =80 =100% attack damage and applies effects from items and abilities. Self Damage increased when targeting enemies.'
			}
		]
	},
	...
	npc_dota_hero_phoenix: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_phoenix_blinding_sun_misschance',
				level: 1
			},
			{
	...
	npc_dota_hero_arc_warden: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Power Capture',
				description:
					'Magnetic Field pulls runes. Arc Warden gains +1.5 all attributes permanently upon activating a Power Rune.'
			}
		]
	},
	...
	npc_dota_hero_mars: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_mars_dauntless_hpregen',
				level: 1
			},
			{
	...
	npc_dota_hero_dawnbreaker: {
		...
		talents: [
			{
				name: 'special_bonus_unique_dawnbreaker_break_of_dawn_damage',
				level: 1
			},
			{
	...
	npc_dota_hero_primal_beast: {
		...
		facets: [
			...
			},
			{
				...
				description: 'Gain 3 Uproar stacks upon being disabled by an enemy hero.'
			},
			{
				id: 2,
	...
	npc_dota_hero_ringmaster: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_ringmaster_dagger_impact_damage',
				level: 1
			},
			{
		...
		facets: [
			{
				...
				title: 'Flutter',
				description:
					'Kez deals extra damage on the first attack after switching to Katana, and gains bonus movement speed after switching to Sai.'
			},
			{
				id: 1,
				name: 'kez_shadowhawk',
				...
				title: 'Shadowhawk',
				description:
					"Triggering a Shodo Sai Mark from invisibility deals bonus critical damage. Increases Raven's Veil invisibility duration.",
