export const heroAbilities = {
		...
		facets: [
			{
				...
				description:
					'Spells countered by Counterspell will immediately burn a percentage of its mana cost from the enemy and deal damage based on the burned mana cost.'
			},
			{
				id: 1,
	...
	npc_dota_hero_bloodseeker: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Old Blood',
				description:
					'Bloodrage silences the target and can be applied to enemies. Bloodrage increases base attack damage instead of spell damage.'
			}
		]
	},
	npc_dota_hero_crystal_maiden: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_crystal_maiden_glacial_guard_mana_multiplier',
				level: 3
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Glacial Guard',
				description:
					'Crystal Nova has increased radius and grants allied heroes a physical damage barrier. Barrier is increased for Crystal Maiden.'
			},
			{
				id: 3,
				...
				description:
					"Activating Arcane Aura temporarily increases Crystal Maiden's spell amplification and mana costs. During the duration, Crystal Maiden restores her and her allies' Mana when casting spells."
			}
		]
	},
	...
	npc_dota_hero_earthshaker: {
		...
		talents: [
			{
				name: 'special_bonus_attack_base_damage_25',
				level: 1
			},
			{
		...
		facets: [
			{
				...
				description:
					'Aftershock radius is increased by {s:bonus_aftershock_range_increase_per_level_interval} for every level of Echo Slam.'
			},
			{
				id: 1,
	...
	npc_dota_hero_juggernaut: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_juggernaut_omnislash_cooldown',
				level: 2
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Bladeform',
				description:
					'Juggernaut gains a stack of Bladeform every 2s that Juggernaut does not take damage. Each stack grants bonus base Agility and Movement Speed. Stacks fade after 2s upon taking any damage.',
	...
	npc_dota_hero_mirana: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_mirana_quiver_damage',
				level: 3
			},
			{
		...
		facets: [
			...
			},
			{
				...
				description:
					'Upon landing, Leap roots targets in a {s:bonus_root_radius} radius for {s:bonus_root_duration}s.'
			}
		]
	},
	npc_dota_hero_nevermore: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_nevermore_frenzy_max_collection_count',
				level: 2
			},
			{
	...
	npc_dota_hero_morphling: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_morphling_7',
				level: 3
			},
			{
				name: 'special_bonus_agility_15',
		...
		facets: [
			{
				...
				title: 'Ebb',
				description:
					"Morphling's Primary Attribute is now Agility. Waveform attacks enemies in his path.",
			...
			},
			{
				...
				title: 'Flow',
				description:
					"Morphling's Primary Attribute is now Strength. Adaptive Strike stuns based on Morphling's strength. Morphling gains 1% Spell Amp per 4 Agility.",
	...
	npc_dota_hero_phantom_lancer: {
		...
		talents: [
			{
				name: 'special_bonus_unique_phantom_lancer_lance_slow_duration',
				level: 1
			},
			{
				name: 'special_bonus_unique_phantom_lancer_juxtapose_illusio_proc_chance',
				level: 1
			},
			{
				name: 'special_bonus_unique_phantom_lancer_illusion_lances',
				level: 2
			},
			{
				name: 'special_bonus_unique_phantom_lancer_doppelwalk_cast_range',
				level: 2
			},
			{
			...
			{
				name: 'special_bonus_unique_phantom_lancer_juxtapose_damage_in',
				level: 3
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Lancelot',
				description:
					"Spirit Lances from Phantom Lancer's illusions deal {s:bonus_illusion_lance_damage_pct}% Lance Damage."
			},
			{
				id: 3,
	...
	npc_dota_hero_puck: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Curveball',
				description:
					"Puck's Illusory Orb can be curved in any direction, moves faster, deals more damage and lasts longer."
			}
		]
	},
	npc_dota_hero_pudge: {
	...
	npc_dota_hero_sand_king: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Sandblast',
				description:
					'When Sand King attacks enemies in Sand Storm, he applies a blinding debuff to his target.'
			},
			{
				id: 3,
				...
				title: 'Final Sting',
				description:
					"A Caustic Finale explosion is created around every enemy hero hit in Stinger's innermost radius."
			}
		]
	},
	...
	npc_dota_hero_sven: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_sven_stormhammer_cooldown',
				level: 3
			},
			{
	...
	npc_dota_hero_windrunner: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_windranger_5',
				level: 2
			},
			{
	...
	npc_dota_hero_zuus: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_zeus_6',
				level: 2
			},
			{
			...
			{
				name: 'special_bonus_unique_zeus_jump_charges',
				level: 4
			}
		],
		facets: [
	...
	npc_dota_hero_kunkka: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_kunkka_tidebringer_armor_pierce',
				level: 4
			}
		],
		facets: [
			...
			},
			{
				...
				title: 'Grog Blossom',
				description:
					"When X Marks the Spot returns its target, Kunkka and all nearby allies gain Ghostship's Admiral's Rum buff."
			}
		]
	},
	npc_dota_hero_lina: {
	...
	npc_dota_hero_lich: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Evil Eye',
				description:
					'Sinister Gaze applies a lingering effect to the target, causing it to take extra magic damage from Lich and amplify incoming movement slows.'
			}
		]
	},
	npc_dota_hero_lion: {
	...
	npc_dota_hero_shadow_shaman: {
		...
		facets: [
			...
			},
			{
				...
				abilities: ['shadow_shaman_voodoo_hands']
			},
			{
				id: 2,
				...
				description:
					'Summons a single massive Serpent Ward with {s:bonus_mega_ward_multiplier_damage}x damage and {s:bonus_mega_ward_multiplier_health}x health and bounty values.'
			}
		]
	},
	npc_dota_hero_slardar: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_slardar_6',
				level: 3
			},
			{
	...
	npc_dota_hero_tidehunter: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_tidehunter_ravage_cooldown',
				level: 2
			},
			{
				name: 'special_bonus_unique_tidehunter_smash_on_blubber',
				level: 3
			},
			{
	...
	npc_dota_hero_witch_doctor: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_witch_doctor_maledict_spread',
				level: 3
			},
			{
	...
	npc_dota_hero_riki: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_riki_tricks_dmg',
				level: 2
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Exterminator',
				description:
					'Tricks of the Trade has 4.5x Agility Bonus when attacking non-hero units. When Riki kills a non-hero unit during Tricks of the Trade, the cooldown is reduced by 0.75s.'
			},
			{
				id: 2,
				name: 'riki_riki',
				...
				title: 'Cutthroat',
				description:
					"This facet doesn't do anything. Riki is still looking to avenge the House of Tahlin..."
			}
		]
	},
	...
	npc_dota_hero_tinker: {
		...
		talents: [
			...
			{
				name: 'special_bonus_mana_reduction_10',
				level: 1
			},
			{
				name: 'special_bonus_unique_tinker_deploy_turrets_knockback',
				level: 2
			},
			{
			...
			{
				name: 'special_bonus_unique_tinker_deploy_turrets_missile_damage',
				level: 3
			},
			{
			...
			{
				name: 'special_bonus_unique_tinker_rearm_channel_time',
				level: 4
			}
		],
		facets: [
	...
	npc_dota_hero_sniper: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_sniper_6',
				level: 2
			},
			{
	...
	npc_dota_hero_necrolyte: {
		...
		talents: [
			...
			{
				name: 'special_bonus_spell_aoe_75',
				level: 3
			},
			{
			...
			{
				name: 'special_bonus_unique_necrophos_reaper_scythe_damage_per_health',
				level: 4
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Rapid Decay',
				description:
					'Ghost Shroud steals speed from his enemies and decreases their restorative powers.'
			}
		]
	},
	npc_dota_hero_warlock: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_warlock_fatal_bonds_count',
				level: 4
			}
		],
		facets: [
	...
	npc_dota_hero_queenofpain: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Bondage',
				description:
					"Queen of Pain returns spell damage back to enemies. Succubus's Spell Lifesteal also applies to Pure & Magical reflected damage.",
				abilities: ['queenofpain_bondage']
			}
		]
	},
	npc_dota_hero_venomancer: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_venomancer_plague_spread',
				level: 2
			},
			{
		...
		facets: [
			...
			},
			{
				...
				description:
					'When Venomous Gale impacts enemy heroes, {s:bonus_num_created_wards_tooltip} Plague Wards are created around them. Plague Wards also deal Septic Shock damage based on their attack damage.'
			}
		]
	},
	...
	npc_dota_hero_skeleton_king: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_wraith_king_facet_1',
				level: 1
			},
			{
			...
			{
				name: 'special_bonus_unique_wraith_king_facet_3',
				level: 3
			},
			{
	...
	npc_dota_hero_phantom_assassin: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Methodical',
				description:
					'Coup de Grace procs every [object Object] attacks on the same hero or [object Object] attacks on non hero units.'
			},
			{
				id: 2,
	...
	npc_dota_hero_pugna: {
		...
		facets: [
			...
			},
			{
				...
				description:
					'Pugna receives {s:bonus_tower_scale}% spell amplification per destroyed tower.'
			}
		]
	},
	npc_dota_hero_templar_assassin: {
		...
		talents: [
			{
				name: 'special_bonus_unique_templar_assassin_meld_duration',
				level: 1
			},
			{
			...
			{
				name: 'special_bonus_unique_templar_assassin_meld_attack_range_bonus',
				level: 2
			},
			{
		...
		facets: [
			{
				...
				title: 'Voidblades',
				description:
					'Meld bonus damage and armor reductions are applied to all enemies in the Psi Blades split range.'
			},
			{
				id: 1,
			...
			},
			{
				...
				title: 'Hidden Reach',
				description:
					'When in Meld, Templar increases her attack range by up to an additional {s:bonus_attack_range_increase_max} range over {s:bonus_attack_range_increase_time}s.'
			}
		]
	},
	npc_dota_hero_viper: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_viper_nethertoxin_radius',
				level: 4
			},
			{
	...
	npc_dota_hero_luna: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_luna_lunar_orbit_glaive_count',
				level: 2
			},
			{
			...
			{
				name: 'special_bonus_unique_luna_lunar_orbit_speed_damage',
				level: 3
			},
			{
	...
	npc_dota_hero_dragon_knight: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_dragon_knight_wyrms_wrath_damage',
				level: 4
			}
		],
		facets: [
			{
				...
				title: 'Fire Dragon',
				description:
					"Dragon Knight deals additional Magic Damage with his attacks. Dragon Knight's abilities have increased Area of Effect that get stronger when in Elder Dragon Form."
			},
			{
				id: 1,
				...
				description:
					'Dragon Knight has Corrosive Powers on his attacks that get stronger when in Elder Dragon Form. All of his abilities deal Physical damage.'
			},
			{
				id: 2,
				...
				title: 'Frost Dragon',
				description:
					'Dragon Knight has Slow and Health Restoration Reduction Effects on his attacks that get stronger when in Elder Dragon Form.'
			}
		]
	},
	npc_dota_hero_dazzle: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_dazzle_nothl_projection_duration',
				level: 2
			},
			{
				name: 'special_bonus_unique_dazzle_shallow_grave_cooldown',
				level: 3
			},
			{
		...
		facets: [
			{
				...
				title: 'Nothl Boon',
				description:
					"Dazzle's overhealing is converted into a barrier. Weave is stronger on allies and amplifies incoming heals from Dazzle.",
			...
			},
			{
				...
				title: 'Poison Bloom',
				description:
					'Dazzle can spread his Poison Touch when attacking enemies. Weave is stronger on enemies.'
			}
		]
	},
	npc_dota_hero_rattletrap: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_clockwerk_hookshot_damage',
				level: 1
			},
			{
			...
			{
				name: 'special_bonus_unique_clockwerk_rocket_flare_charges',
				level: 4
			},
			{
		...
		facets: [
			{
				...
				title: 'Hookup',
				description:
					"If there's another allied hero within {s:bonus_radius_ally} of Hookshot's hit target, Clockwerk and all allies in the area receive bonus armor, while refunding a portion of Hookshot's cooldown and manacost."
			},
			{
				id: 1,
			...
			},
			{
				...
				title: 'Chainmeal',
				description:
					'Clockwerk can consume Chainmails to permanently gain +{s:bonus_armor_per_chainmail} armor.'
			}
		]
	},
		...
		facets: [
			{
				...
				description:
					'After Sprout is cast, all trees in a {s:bonus_healing_radius} radius heal nearby allies.'
			},
			{
				id: 1,
				...
				description:
					"Nature's Call creates only {s:bonus_max_treants} Treant that has more health, more damage, increased vision, increased movement speed, and is Reinforced."
			},
			{
				id: 2,
				...
				description:
					"Whenever Nature's Prophet kills an enemy hero or one dies nearby, a money tree is created in their place that drops gold bags to be collected.",
				abilities: ['furion_natures_profit']
			}
		]
	},
	npc_dota_hero_life_stealer: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Fleshfeast',
				description:
					"Feast's max HP per hero kill is increased. Open Wounds' cooldown is refreshed if a unit dies while afflicted by Open Wounds."
			},
			{
				id: 4,
				...
				title: 'Gorestorm',
				description:
					"Consuming a creep with Infest drenches enemies in blood which deals damage over time based on the host's remaining health. Infest can be used on Ancient creeps."
			}
		]
	},
	...
	npc_dota_hero_clinkz: {
		...
		talents: [
			...
			{
				name: 'special_bonus_attack_range_50',
				level: 2
			},
			{
	...
	npc_dota_hero_huskar: {
		...
		talents: [
			...
			{
				name: 'special_bonus_lifesteal_12',
				level: 2
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Cauterize',
				description:
					"Berserker's Blood can be activated for a health cost. Dispels Huskar, then after a delay, heals for the amount of health consumed plus an additional bonus per debuff dispelled."
			},
			{
				id: 3,
				...
				title: 'Incendiary',
				description:
					'Burning Spears also burns enemies for a percentage of their max health. Costs Max Health instead of Current Health.'
			}
		]
	},
	npc_dota_hero_night_stalker: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_night_stalker_crippling_fear_radius',
				level: 3
			},
			{
				name: 'special_bonus_strength_15',
		...
		facets: [
			...
			},
			{
				...
				title: 'Voidbringer',
				description:
					'Increases the max level of Void. Level 5 Void at night becomes ground targeted and applies to an area.'
			}
		]
	},
	npc_dota_hero_broodmother: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_broodmother_web_speed',
				level: 4
			}
		],
		facets: [
	...
	npc_dota_hero_bounty_hunter: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Cutpurse',
				description:
					'Bounty Hunter steals 4 gold when targeting enemy heroes with his abilities or items.',
	...
	npc_dota_hero_weaver: {
		...
		talents: [
			{
				name: 'special_bonus_unique_weaver_shukuchi_movespeed',
				level: 1
			},
			{
				name: 'special_bonus_strength_7',
	...
	npc_dota_hero_jakiro: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_jakiro_dualbreath_cooldown',
				level: 2
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Ice Breaker',
				description:
					'Ice Path lasts longer and detonates upon expiration, dealing damage and stunning enemies a second time. Ice Path can be manually detonated early.',
				abilities: ['jakiro_ice_path_detonate']
			}
		]
	},
		...
		facets: [
			{
				...
				title: 'Stoked',
				description:
					'Firefly also lights Batrider on fire. He gains increasingly more Move Speed and burns away a portion of his max health each second.'
			},
			{
				id: 1,
				...
				title: 'Arsonist',
				description:
					'Increases the max level of Sticky Napalm. Level 5 Sticky Napalm causes every attack to apply 1 stack of Sticky Napalm.'
			}
		]
	},
	npc_dota_hero_chen: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_chen_zealot',
				level: 1
			},
			{
			...
			{
				name: 'special_bonus_unique_chen_divine_favor_healing',
				level: 3
			},
			{
	...
	npc_dota_hero_spectre: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_spectre_shadow_step_duration',
				level: 2
			},
			{
		...
		facets: [
			{
				...
				title: 'Forsaken',
				description:
					"Spectre deals {s:bonus_bonus_damage_multiplier_tooltip}x damage with Desolate. Spectre's illusions no longer have Desolate."
			},
			{
				id: 1,
			...
			},
			{
				...
				title: 'Ephemeral',
				description:
					"This facet doesn't do anything. Spectre is still transcending between Planes..."
			}
		]
	},
	npc_dota_hero_doom_bringer: {
		...
		talents: [
			...
			{
				name: 'special_bonus_attack_damage_66',
				level: 2
			},
			{
		...
		facets: [
			{
				...
				title: 'Gluttony',
				description:
					'Devour now has {s:bonus_AbilityCharges} charges and stolen creep abilities are upgraded by one level.'
			},
			{
				id: 1,
			...
			},
			{
				...
				description:
					"Every {s:bonus_upgrade_interval} minutes, Doom's duration is increased by {s:bonus_upgrade_amount}s."
			}
		]
	},
	npc_dota_hero_ancient_apparition: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_ancient_apparition_cold_feet_dps',
				level: 1
			},
			{
			...
			{
				name: 'special_bonus_unique_ancient_apparition_cold_feet_distance',
				level: 2
			},
			{
	...
	npc_dota_hero_ursa: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_ursa_maul_health',
				level: 2
			},
			{
	...
	npc_dota_hero_spirit_breaker: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_spirit_breaker_increased_charge_speed',
				level: 2
			},
			{
				name: 'special_bonus_unique_bull_rush_movement_increase',
				level: 3
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: "Bull's Hit",
				description:
					"Greater Bash chance is increased if you've bashed more than one hero recently."
			}
		]
	},
	...
	npc_dota_hero_alchemist: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_alchemist_weaponry_power',
				level: 2
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Dividends',
				description:
					"Alchemist gains +{s:bonus_gpm_increase_per_stack} GPM for each Aghanim's Scepter he has granted to allies."
			}
		]
	},
	npc_dota_hero_invoker: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_invoker_orb_levels',
				level: 3
			},
			{
		...
		facets: [
			{
				...
				description:
					"Quas gains an additional max level. When Invoker reaches level 6, Quas gains an additional level.\n\nAghanim's Scepter upgrades Ice Wall.\n\nAghanim's Shard upgrades Ghost Walk."
			},
			{
				id: 1,
				...
				description:
					"Wex gains an additional max level. When Invoker reaches level 6, Wex gains an additional level.\n\nAghanim's Scepter upgrades Tornado.\n\nAghanim's Shard upgrades E.M.P."
			},
			{
				id: 2,
				...
				description:
					"Exort gains an additional max level. When Invoker reaches level 6, Exort gains an additional level.\n\nAghanim's Scepter upgrades Sun Strike.\n\nAghanim's Shard upgrades Sun Strike."
			}
		]
	},
	npc_dota_hero_silencer: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_silencer_brain_drain_damage',
				level: 1
			},
			{
			...
			{
				name: 'special_bonus_unique_silencer_5',
				level: 3
			},
			{
			...
			{
				name: 'special_bonus_unique_silencer_global_duration',
				level: 4
			}
		],
		facets: [
			...
			},
			{
				...
				description:
					'Increases the max level of Glaives of Wisdom. Level {s:bonus_max_level_tooltip} Glaives of Wisdom bounce {s:bonus_bounce_count_tooltip} time to a random target within {s:bonus_bounce_range_tooltip} range.'
			},
			{
				id: 3,
				...
				abilities: ['silencer_oppressive_silence']
			}
		]
	},
	npc_dota_hero_obsidian_destroyer: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_outworld_devourer_flux_restore',
				level: 2
			},
			{
			...
			{
				name: 'special_bonus_unique_outworld_devourer_barrier',
				level: 3
			},
			{
	...
	npc_dota_hero_brewmaster: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_brewmaster_brewed_up_duration',
				level: 1
			},
			{
			...
			{
				name: 'special_bonus_unique_brewmaster_primal_split_cooldown',
				level: 3
			},
			{
				name: 'special_bonus_attack_speed_110',
				level: 3
			},
			{
				name: 'special_bonus_unique_brewmaster_drunken_brawler_stance_bonus',
				level: 4
			},
			{
		...
		facets: [
			...
			},
			{
				...
				description:
					'When brewed up, Brewmaster moves with a varying amount of movement speed, altering between {s:bonus_min_movement}% slower and {s:bonus_max_movement}% faster for the duration.'
			},
			{
				id: 2,
				...
				title: 'Hungover',
				description:
					"This facet doesn't do anything. Brewmaster is still recovering from a drunken stupor..."
			}
		]
	},
	npc_dota_hero_shadow_demon: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_shadow_demon_purge_poison',
				level: 4
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Soul Catcher',
				description:
					"Shadow Demon and his illusions' attacks reduce the current health of the target by 1% per stack. When the effect expires, the target regains 50% of the lost health.\n\nIf an enemy Hero dies under this effect, Shadow Demon creates an illusion of them that lasts until the Hero respawns or Shadow Demon dies.",
	...
	npc_dota_hero_lone_druid: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_lone_druid_1',
				level: 1
			},
			{
			...
			{
				name: 'special_bonus_attack_speed_55',
				level: 3
			},
			{
			...
			{
				name: 'special_bonus_unique_lone_druid_entangle_duration',
				level: 4
			}
		],
		facets: [
	...
	npc_dota_hero_chaos_knight: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Irrationality',
				description:
					'Reality Rift has equal chances of applying Break, Disarm, or Silence for {s:bonus_additional_debuff_duration_percent}% of the base debuff duration in addition to its normal effects.'
			},
			{
				id: 2,
				...
				description:
					'Chaos Knight can craft artifacts from the next tier when making a Neutral Item.',
				abilities: ['chaos_knight_fundamental_forging']
			},
			{
				id: 3,
				...
				title: 'Cloven Chaos',
				description:
					'Chaos Bolt splits in half upon striking its target, stunning one additional enemy and damaging another.'
			}
		]
	},
	npc_dota_hero_meepo: {
		...
		facets: [
			{
				...
				abilities: ['treant_innate_attack_damage']
			},
			{
				id: 1,
				name: 'treant_sapling',
	...
	npc_dota_hero_ogre_magi: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_ogre_magi_multicast_chance',
				level: 4
			}
		],
		facets: [
			{
				...
				title: 'Fat Chance',
				description:
					"Each point of Ogre Magi's Strength adds {s:bonus_strength_mult}% to Ogre Magi's Multicast chance."
			},
			{
				id: 1,
	...
	npc_dota_hero_rubick: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_rubick_fade_bolt_spell_reduction',
				level: 3
			},
			{
			...
			{
				name: 'special_bonus_unique_rubick_curiosity_factor',
				level: 4
			},
			{
	...
	npc_dota_hero_disruptor: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_disruptor_thunder_strike_strikes',
				level: 4
			}
		],
		facets: [
			{
				...
				title: 'Thunderstorm',
				description:
					'Thunder Strike additionally hits all enemies within Kinetic Field. Thunder Strike Slow duration is increased.'
			},
			{
				id: 1,
			...
			},
			{
				...
				title: 'Transference',
				description:
					"Electromagnetic Repulsion can be activated manually, be cast on allies and deals damage equal to a percentage of Disruptor's current health."
			}
		]
	},
	npc_dota_hero_nyx_assassin: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Scuttle',
				description:
					'For the first {s:bonus_free_pathing_duration}s of Vendetta, Nyx Assassin is hasted and has unobstructed pathing.'
			}
		]
	},
	npc_dota_hero_naga_siren: {
		...
		talents: [
			{
				name: 'special_bonus_unique_naga_siren_reel_in_speed',
				level: 1
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Deluge',
				description:
					'Naga Siren can create a splash around herself and her illusions, damaging enemies and capping their max movement speed.',
	...
	npc_dota_hero_wisp: {
		...
		talents: [
			{
				name: 'special_bonus_unique_wisp_overcharge_duration',
				level: 1
			},
			{
				name: 'special_bonus_strength_8',
			...
			{
				name: 'special_bonus_unique_wisp_relocate_delay',
				level: 4
			},
			{
	...
	npc_dota_hero_visage: {
		...
		talents: [
			{
				name: 'special_bonus_unique_visage_soul_assumption_cooldown',
				level: 1
			},
			{
			...
			{
				name: 'special_bonus_unique_visage_cloak_recovery_time',
				level: 4
			},
			{
	...
	npc_dota_hero_slark: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Fugitive',
				description:
					"This facet doesn't do anything. Slark is still reeling from nightmares about Dark Reef..."
			}
		]
	},
	npc_dota_hero_medusa: {
		...
		talents: [
			{
				name: 'special_bonus_unique_medusa_gorgons_grasp_radius',
				level: 1
			},
			{
			...
			{
				name: 'special_bonus_unique_medusa_gorgons_grasp_volleys',
				level: 2
			},
			{
			...
			{
				name: 'special_bonus_intelligence_40',
				level: 4
			}
		],
		facets: [
			...
			},
			{
				...
				title: 'Undulation',
				description:
					"Medusa's movement speed is fixed at 310 (465 during Stone Gaze). Medusa is unslowable and does not benefit from movement speed increases.",
				abilities: ['medusa_undulation']
			}
		]
	},
	npc_dota_hero_troll_warlord: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Bad Influence',
				description:
					'During Battle Trance, Troll Warlord has increased max Fervor stacks and no attack speed limit. Battle Trance grants allied heroes {s:bonus_attack_speed_share_percent}% of the attack speed bonus. '
			}
		]
	},
	...
	npc_dota_hero_magnataur: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_magnus_skewer_damage_distance',
				level: 3
			},
			{
		...
		facets: [
			...
			},
			{
				...
				description:
					"Increases the max level of Shockwave. Level {s:bonus_max_level_tooltip} Shockwave causes it to return towards Magnus's location."
			},
			{
				id: 4,
	...
	npc_dota_hero_shredder: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_timbersaw_exposure_therapy_health',
				level: 3
			},
			{
	...
	npc_dota_hero_bristleback: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Seeing Red',
				description:
					"Warpath can be activated to gain extra bonuses. While Seeing Red, Bristleback's vision is limited and he does not receive vision from his allies."
			}
		]
	},
	npc_dota_hero_tusk: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_tusk_shard_dps',
				level: 4
			},
			{
	...
	npc_dota_hero_abaddon: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_abaddon_borrowed_time_cd',
				level: 2
			},
			{
		...
		facets: [
			...
			},
			{
				...
				description:
					'Mist Coil also deals {s:bonus_damage_percentage_on_perform_attack}% attack damage and applies effects from items and abilities. Self Damage increased when targeting enemies.'
			}
		]
	},
	npc_dota_hero_elder_titan: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_elder_titan_momentum_attack_speed',
				level: 2
			},
			{
	...
	npc_dota_hero_legion_commander: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_legion_commander_outfight_them_armor',
				level: 1
			},
			{
			...
			{
				name: 'special_bonus_unique_legion_commander_duel_duration',
				level: 3
			},
			{
			...
			{
				name: 'special_bonus_unique_legion_commander_duel_refresh_on_victory',
				level: 4
			}
		],
		facets: [
			...
			},
			{
				...
				title: 'Spoils of War',
				description:
					'When a Duel is won, units that damaged the loser during the Duel will gain permanent bonus damage. If Legion Commander won the Duel, she will automatically cast Press the Attack on herself and assisting allies.'
			}
		]
	},
	npc_dota_hero_ember_spirit: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Chain Gang',
				description:
					'Searing Chains can affect two additional enemies. When Searing Chains are cast, they are also cast around each Fire Remnant.'
			}
		]
	},
	npc_dota_hero_earth_spirit: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_earth_spirit_rolling_boulder_stun',
				level: 2
			},
			{
	...
	npc_dota_hero_terrorblade: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_terrorblade_sunder_hp_threshold',
				level: 2
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Soul Fragment',
				description:
					'Conjure Image illusions always spawn at full health and cost health instead of mana.'
			}
		]
	},
	npc_dota_hero_phoenix: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_phoenix_dying_light_damage',
				level: 1
			},
			{
	...
	npc_dota_hero_techies: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_techies_tazer_duration',
				level: 2
			},
			{
			...
			{
				name: 'special_bonus_attack_damage_253',
				level: 4
			},
			{
	...
	npc_dota_hero_winter_wyvern: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Winterproof',
				description:
					'Cold Embrace can be cast on buildings. Does not heal buildings. Allied units and buildings gain bonus attack damage when emerging from the icy cocoon.'
			},
			{
				id: 3,
				...
				title: 'Recursive',
				description:
					"Winter's Curse is recast on the lowest health enemy hero if the primary target dies."
			}
		]
	},
	...
	npc_dota_hero_monkey_king: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Simian Stride',
				description:
					'Increases the max level of Tree Dance. Level 5 Tree Dance reduces the cooldown to zero.'
			},
			{
				id: 2,
				...
				abilities: ['monkey_king_transfiguration']
			}
		]
	},
	npc_dota_hero_pangolier: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_pangolier_shield_crash_cooldown',
				level: 3
			},
			{
		...
		facets: [
			...
			},
			{
				...
				description:
					"This facet doesn't do anything. Pangolier is still recovering from a heroic exploit..."
			}
		]
	},
	npc_dota_hero_dark_willow: {
		...
		facets: [
			...
			},
			{
				...
				description:
					'Cursed Crown accumulates all damage dealt by Dark Willow and attack damage dealt by her allies. A percentage of that damage is dealt again as magical damage to the whole area when the counter expires.'
			}
		]
	},
	npc_dota_hero_grimstroke: {
		...
		facets: [
			...
			},
			{
				...
				title: 'Fine Art',
				description:
					'Stroke of Fate additionally launches a reflected curved stroke from the right hand.'
			}
		]
	},
	npc_dota_hero_mars: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_mars_arena_of_blood_damage',
				level: 3
			},
			{
		...
		facets: [
			{
				...
				title: 'Victory Feast',
				description:
					'Mars and his allies gain health, mana, and attack damage when an enemy inside his Arena of Blood dies.'
			},
			{
				id: 1,
				name: 'mars_arena',
	...
	npc_dota_hero_void_spirit: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_void_spirit_resonant_pulse_barrier',
				level: 2
			},
			{
	...
	npc_dota_hero_snapfire: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_snapfire_firesnap_cookie_additional_charge',
				level: 3
			},
			{
	...
	npc_dota_hero_hoodwink: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_hoodwink_scurry_charges',
				level: 2
			},
			{
			...
			{
				name: 'special_bonus_unique_hoodwink_sharpshooter_vision',
				level: 3
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Hipshot',
				description:
					'Sharpshooter has a greatly reduced cooldown. Damage, debuff duration, turn time, and wind-up times are also reduced.'
			}
		]
	},
	npc_dota_hero_dawnbreaker: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_dawnbreaker_celestial_hammer_targets_allies',
				level: 1
			},
			{
				name: 'special_bonus_unique_dawnbreaker_celestial_hammer_damage',
				level: 2
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Starsurge',
				description:
					'Dawnbreaker and nearby allies gain bonus attack speed at the end of Starbreaker for each swipe that hit enemy heroes.'
			},
			{
				id: 3,
	...
	npc_dota_hero_marci: {
		...
		talents: [
			{
				name: 'special_bonus_unique_marci_dispose_slow',
				level: 1
			},
			{
				name: 'special_bonus_unique_marci_rebound_radius',
				level: 1
			},
			{
			...
			{
				name: 'special_bonus_unique_marci_guardian_strong_dispel',
				level: 4
			}
		],
		facets: [
			...
			},
			{
				...
				title: 'Buddy System',
				description:
					'While bodyguarded, Marci and her partner share a portion of health healed by this ability with each other.'
			},
			{
				id: 3,
				name: 'marci_pickmeup',
	...
	npc_dota_hero_primal_beast: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_primal_beast_colossal_trample',
				level: 4
			},
			{
		...
		facets: [
			...
			},
			{
				...
				description:
					'Gain {s:bonus_stack_count_increase_on_disable} Uproar stacks upon being disabled by an enemy hero.'
			},
			{
				id: 2,
	...
	npc_dota_hero_muerta: {
		...
		talents: [
			...
			{
				name: 'special_bonus_intelligence_15',
				level: 2
			},
			{
				name: 'special_bonus_unique_muerta_pierce_the_veil_duration',
				level: 3
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: 'Quickdraw',
				description:
					'Dead Shot fears increase Gunslinger chance.\n\nGunslinger procs reduce Dead Shot cooldown. '
			}
		]
	},
	npc_dota_hero_ringmaster: {
		...
		talents: [
			{
				name: 'special_bonus_unique_ringmaster_dagger_charge',
				level: 1
			},
			{
		...
		facets: [
			...
			},
			{
				...
				description:
					"Ringmaster's Souvenirs are Funhouse Mirror, Strongman Tonic, and Whoopee Cushion.",
				abilities: [
	...
	npc_dota_hero_kez: {
		...
		talents: [
			...
			{
				name: 'special_bonus_unique_kez_raptor_dance_strikes',
				level: 2
			},
			{
			...
			{
				name: 'special_bonus_unique_kez_falcon_rush_attack_speed',
				level: 3
			},
			{
		...
		facets: [
			...
			},
			{
				...
				title: '',
				description: '',
				abilities: ['kez_shadowhawk_passive']
			}
		]
	},
	npc_dota_hero_largo: {
		...
		talents: [
			{
				name: 'special_bonus_unique_largo_1',
				level: 1
			},
			{
				name: 'special_bonus_unique_largo_2',
				level: 1
			},
			{
				name: 'special_bonus_unique_largo_3',
				level: 2
			},
			{
				name: 'special_bonus_unique_largo_4',
				level: 2
			},
			{
				name: 'special_bonus_unique_largo_5',
				level: 3
			},
			{
				name: 'special_bonus_unique_largo_6',
				level: 3
			},
			{
				name: 'special_bonus_unique_largo_7',
				level: 4
			},
			{
				name: 'special_bonus_unique_largo_8',
				level: 4
			}
		],
		facets: [
			{
				...
				description:
					"This facet doesn't do anything. Largo just arrived from the island of Velu'Mar..."
			}
		]
	}
};
