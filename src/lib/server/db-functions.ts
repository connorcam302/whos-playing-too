...
export const getMostKills = async (games: number = 10, smurf: boolean = false) => {
    const mostKills = await db
        .select({
            id: players.id,
            username: players.username,
...
export const getMostDeaths = async (games: number = 10, smurf: boolean = false) => {
    const mostDeaths = await db
        .select({
            id: players.id,
            username: players.username,
...
export const getMostAssists = async (games: number = 10, smurf: boolean = false) => {
    const mostAssists = await db
        .select({
            id: players.id,
            username: players.username,
...
export const getHighestImpact = async (games: number = 10, smurf: boolean = false) => {
...
export const getLowestImpact = async (games: number = 10, smurf: boolean = false) => {
