...
<button
	...
	class="hover:text-neutral-300 transition-all duration-300 w-full h-full"
>
	<slot />
</button>
...
{#if showMatchData}
	...
	>
		<div
			class="absolute opacity-100 bg-neutral-800 border-[1px] border-neutral-200 border-opacity-15 px-4 py-2 rounded-xl z-20"
		>
			{#if !matchDetails}
						...
						<div class="overflow-x-auto max-w-[97vw]">
							<div class="min-w-[1432px]">
								<table class="table-auto">
									<thead>
										<tr>
											<th class="text-neutral-400 font-normal text-xs w-40">PLAYER</th>
											<th class="text-neutral-400 font-normal text-xs w-12">POS</th>
											<th class="text-neutral-400 font-normal text-xs w-12">LEVEL</th>
											<th class="text-neutral-400 font-normal text-xs w-10">K</th>
											<th class="text-neutral-400 font-normal text-xs w-10">D</th>
											<th class="text-neutral-400 font-normal text-xs w-10">A</th>
											<th class="text-neutral-400 font-normal text-xs w-12">IMP</th>
											<th class="text-neutral-400 font-normal text-xs max-w-20">CS</th>
											<th class="text-neutral-400 font-normal text-xs w-20">NET</th>
											<th class="text-neutral-400 font-normal text-xs w-20">GPM</th>
											<th class="text-neutral-400 font-normal text-xs w-20">XPM</th>
											<th class="text-neutral-400 font-normal text-xs w-20">HD</th>
											<th class="text-neutral-400 font-normal text-xs w-20">TD</th>
											<th class="text-neutral-400 font-normal text-xs w-20">HH</th>
